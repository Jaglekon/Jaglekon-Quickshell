pragma Singleton
        ...
        QtObject {
          ...
          property color background_var: "{{colors.surface_container_high.default.hex}}"
          property color selection_background: "{{colors.primary_fixed.default.hex}}"
          property color blue: "{{colors.primary.default.hex}}"
          property color border: "{{colors.primary_container.default.hex}}"
          property color red: "{{colors.error_container.default.hex}}"
